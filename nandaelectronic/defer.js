...
//  base_url='http://127.0.0.1:5500/nandaelectronic/';
hash_data=[];
...
function home()
{
    ...
    <a href="#nimish" class="catogree-name-catcher"><P>nimish</P></a>
        ...
        <a href="${base_to_url}contact-us.html" class="catogree-name-quire-to-contactus"><buttton style="background-color: aqua;" >click on it to go to contact-us</buttton></a>
